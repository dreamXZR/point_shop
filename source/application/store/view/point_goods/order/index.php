                                ...
                                <div class="am-form-group">
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <?php if (checkPrivilege('point_goods.order.operate/export')): ?>
                                        ...
                                        <?php if ($i === 1) : $goodsCount = count($order['goods']); ?>
                                            ...
                                            <td class="am-text-middle" rowspan="<?= $goodsCount ?>">
                                                <div class="tpl-table-black-operation">
                                                    <?php if (checkPrivilege('point_goods.order/detail')): ?>
                                                        <a class="tpl-table-black-operation-green"
                                                           href="<?= url('point_goods.order/detail', ['order_id' => $order['order_id']]) ?>">
                                                            订单详情</a>
                                                    <?php endif; ?>
                                                    <?php if (checkPrivilege(['point_goods.order/detail', 'point_goods.order/delivery'])): ?>
                                                        <?php if ($order['pay_status']['value'] == 20
                                                            ...
                                                            <a class="tpl-table-black-operation"
                                                               href="<?= url('point_goods.order/detail#delivery',
                                                                   ['order_id' => $order['order_id']]) ?>">去发货</a>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    <?php if (checkPrivilege(['point_goods.order/detail', 'point_goods.order.operate/confirmcancel'])): ?>
                                                        <?php if ($order['order_status']['value'] == 21): ?>
                                                            <a class="tpl-table-black-operation-del"
                                                               href="<?= url('point_goods.order/detail#cancel',
