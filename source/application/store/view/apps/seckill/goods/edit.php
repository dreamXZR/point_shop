                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="number" min="0" class="tpl-form-input"
                                               ...
                                               value="<?= $model['sku'][0]['line_price'] ?>" required>
                                    </div>
                                </div>
                                <div class="am-form-group">
...
<script src="assets/common/js/laydate.js"></script>
<script src="assets/common/plugins/umeditor/umeditor.config.js?v=<?= $version ?>"></script>
<script src="assets/common/plugins/umeditor/umeditor.min.js"></script>
<script src="assets/store/js/goods.spec.js?v=<?= $version ?>"></script>
<script src="assets/store/js/seckill_goods.spec.js?v=<?= $version ?>"></script>
<script>
    laydate.render({
        elem: '#start_at' //指定元素
        ,type: 'datetime'
