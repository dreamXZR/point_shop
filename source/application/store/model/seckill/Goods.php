...
class Goods extends GoodsModel
{
    ...
    public function add(array $data)
    {
        ...
        $data['wxapp_id'] = $data['sku']['wxapp_id'] = config('mini_weixin.wxapp_id');
    ...
    public function edit($data)
    {
        ...
        $data['content'] = isset($data['content']) ? $data['content'] : '';
        $data['wxapp_id'] = $data['sku']['wxapp_id'] = config('mini_weixin.wxapp_id');
        $data['store_shop_id'] = $this->admin_user['store_shop_id'];$data['store_shop_id'] = $this->admin_user['store_shop_id'];
        // 开启事务
        $this->startTrans();
        try {
            // 保存商品
