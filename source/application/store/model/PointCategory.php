 ...
 */
class PointCategory extends CategoryModel
{
...
//        }
    ...
    {
        return Cache::rm('point_category_' . self::$wxapp_id);
    }
    ...
    {
        $model = new static;
        if (!Cache::get('point_category_' . $model::$wxapp_id)) {
            ...
            Cache::tag('cache')->set('point_category_' . $model::$wxapp_id, compact('all', 'tree'));
        }
        return Cache::get('point_category_' . $model::$wxapp_id);
    }
